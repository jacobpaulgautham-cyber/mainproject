...
foreach ($file in $htmlFiles) {
    ...
    if ($content -notmatch '<a href="products\.html"') {
        $content = $content -replace '(<li><a href="artisans_filmstrip_page4\.html"[^>]*>Artisans</a></li>)', "$1`n    <li><a href=`"products.html`" class=`"nav-link`">Products</a></li>"
